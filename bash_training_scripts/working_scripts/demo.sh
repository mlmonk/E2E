...
MODEL=baseline_test_struc_devel
MODEL_DIR=/home/nikhil/Projects/E2E-NLG-Challenge/E2E/model
TGEN=$BASE/tgen
OUTPUT=$BASE/output_struc_devel
OPENNMT=/home/nikhil/OpenNMT-py
GPU=0
TOTAL_GPUS=1
python $OPENNMT/preprocess.py -train_src $BASE/devset-struc-source.tok  -train_tgt $BASE/devset-struc-target.tok -valid_src $BASE/devset-struc-source.tok -valid_tgt $BASE/devset-struc-target.tok -save_data $BASE/$MODEL -src_seq_length 1000 -tgt_seq_length 1000 -dynamic_dict -share_vocab
