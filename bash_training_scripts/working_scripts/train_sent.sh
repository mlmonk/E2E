...
GPU=0
TOTAL_GPUS=1
python $OPENNMT/preprocess.py -train_src $BASE/trainset-source.tok  -train_tgt $BASE/trainset-struc-source.tok -valid_src $BASE/devset-source.tok -valid_tgt $BASE/devset-struc-source.tok -save_data $BASE/$MODEL -src_seq_length 1000 -tgt_seq_length 1000 -dynamic_dict -share_vocab
